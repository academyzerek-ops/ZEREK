...
      R = (R<sub>1</sub> + R<sub>2</sub> + ... + R<sub>n</sub>)/n,

      где:

      R – среднеарифметический официальный курс валюты за период;

      R<sub>1</sub>, R<sub>2</sub>, R<sub>n</sub> – официальный курс соответствующей валюты, установленный на каждый рабочий день периода в течение периода;
