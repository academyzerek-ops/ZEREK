...
def quick_check(req: QCReq):
    """Quick Check $10 — двухшаговый calc → render.
...
2. **Обзоры рынка** — ниши малого бизнеса × 14 городов РК. Бесплатно.

3. **Кейсы (Чужие грабли)** — реальные истории провалов и успехов.

4. **Расчёты:**
   - Экспресс-оценка — $10
   - Финансовая модель — $20: Excel на 60 месяцев
   - Бизнес-план + питч — $20 (скоро)
