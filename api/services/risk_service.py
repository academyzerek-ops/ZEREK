...
HOME_SPECIFIC_RISKS = [
    ...
    # UX #7: «Потолок дохода одного мастера» убран — дублировался с новым
    # блоком «Парадокс штата» (staff_paradox), который показывает то же
    # подробнее с цифрами и вариантами роста.
