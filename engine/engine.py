...
class ZerekDB:
    ...
    def _load(self):
        ...
        # 05 — Налоги 2026 (заменил старый 05 + 06)
        self.tax_regimes = self._xl("05_tax_regimes_2026_updated.xlsx", "tax_regimes_2026", 0)
        self.city_tax_rates = self._xl("05_tax_regimes_2026_updated.xlsx", "city_ud_rates_2026", 0)
        self.b2b_warnings = self._xl("05_tax_regimes_2026_updated.xlsx", "b2b_nds_warnings", 0)
        self.payroll_taxes = self._xl("05_tax_regimes_2026_updated.xlsx", "payroll_taxes_2026", 0)
        self.key_params = self._xl("05_tax_regimes_2026_updated.xlsx", "key_params_2026", 0)
